...
- Move the skill under skills/ and add the portable manifest (layout)

## [1.2.3] - 2026-08-03

### Changed

- Dependency lock file maintenance (Renovate).

## [1.2.2] - 2026-07-13

### Changed

- Trimmed generic best-practices content from AGENTS.md.
- Dependency lock file maintenance (Renovate).
